          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Text(
                    colorMode == ColorMode.byType
                        ? 'LỌC THEO CẤP HÀNH CHÍNH'
                        : 'LỌC THEO CẤP HÀNH CHÍNH',
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isActive = activeCategories.contains(cat);
                final color = categoryColors[cat] ?? const Color(0xFF90A4AE);
                    ...
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(8),
                          border: Border.all(
                            color: isActive ? color.withValues(alpha: 0.5) : const Color(0xFF2A3F54),
                            width: 1,
                          ),
                        ),
                        child: Row(
